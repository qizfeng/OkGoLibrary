 ...
 * -
 * -如果你对这里的代码原理不清楚，可以看这里的详细原理说明：https://github.com////okhttp-OkGo/blob/master/README_JSONCALLBACK.md
 * -如果你对这里的代码原理不清楚，可以看这里的详细原理说明：https://github.com////okhttp-OkGo/blob/master/README_JSONCALLBACK.md
 * -如果你对这里的代码原理不清楚，可以看这里的详细原理说明：https://github.com////okhttp-OkGo/blob/master/README_JSONCALLBACK.md
 * -
 * -
...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        // https://github.com////okhttp-OkGo/blob/master/README_JSONCALLBACK.md 这里的第一种方式定义就可以实现
        ...
        if (typeArgument == Void.class) {
            ...
            if (obj.has("errNum")) {//先判断errNum,在解析,以防数据不规范报错
                ...
                String message = obj.opt("message") + "";
                if ("0".equals(errNum)) {
