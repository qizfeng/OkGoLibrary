...
import static com.library.okgo.view.expandrecyclerview.ExpandableAdapter.ExpandCollapseMode.MODE_DEFAULT;
import static com.library.okgo.view.expandrecyclerview.ExpandableAdapter.ExpandCollapseMode.MODE_SINGLE_COLLAPSE;
import static com.library.okgo.view.expandrecyclerview.ExpandableAdapter.ExpandCollapseMode.MODE_SINGLE_EXPAND;
        ...
        extends RecyclerView.Adapter<BaseViewHolder>
{
    ...
    private int addParentWrapper(int parentWrapperPosition, int newParentPosition) {
        ...
        if ((newItemWrapper.isInitiallyExpanded() &&
             getExpandCollapseMode() != MODE_SINGLE_EXPAND) ||
            getExpandCollapseMode() == MODE_SINGLE_COLLAPSE)
        {
    ...
    private void checkSingleExpandMode(int currExpandedParentPosition) {
        if (mExpandCollapseMode == null ||
            mExpandCollapseMode.mode != MODE_SINGLE_EXPAND) return;
    ...
    private void checkSingleCollapseMode(int currCollapsedParentPosition) {
        if (mExpandCollapseMode == null ||
            mExpandCollapseMode.mode != MODE_SINGLE_COLLAPSE) return;
