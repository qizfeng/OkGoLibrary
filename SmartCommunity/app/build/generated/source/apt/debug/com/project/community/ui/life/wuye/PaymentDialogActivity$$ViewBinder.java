...
public class PaymentDialogActivity$$ViewBinder<T extends com.project.community.ui.life.wuye.PaymentDialogActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624175, "field 'mLayoutAlipay'");
    target.mLayoutAlipay = finder.castView(view, 2131624175, "field 'mLayoutAlipay'");
    view = finder.findRequiredView(source, 2131624178, "field 'mLayoutWeipay'");
    target.mLayoutWeipay = finder.castView(view, 2131624178, "field 'mLayoutWeipay'");
    view = finder.findRequiredView(source, 2131624177, "field 'mBtnAlipay'");
    target.mBtnAlipay = finder.castView(view, 2131624177, "field 'mBtnAlipay'");
    view = finder.findRequiredView(source, 2131624179, "field 'mBtnWeipay'");
    target.mBtnWeipay = finder.castView(view, 2131624179, "field 'mBtnWeipay'");
