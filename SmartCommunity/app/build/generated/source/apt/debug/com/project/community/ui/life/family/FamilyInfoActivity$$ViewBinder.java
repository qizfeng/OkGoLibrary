...
public class FamilyInfoActivity$$ViewBinder<T extends com.project.community.ui.life.family.FamilyInfoActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624173, "field 'mTabLayout'");
    target.mTabLayout = finder.castView(view, 2131624173, "field 'mTabLayout'");
    ...
    view = finder.findRequiredView(source, 2131624175, "field 'mIvAdd'");
    target.mIvAdd = finder.castView(view, 2131624175, "field 'mIvAdd'");
  }
