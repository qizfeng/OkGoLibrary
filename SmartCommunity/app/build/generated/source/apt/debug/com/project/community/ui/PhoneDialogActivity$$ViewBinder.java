...
public class PhoneDialogActivity$$ViewBinder<T extends com.project.community.ui.PhoneDialogActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624164, "field 'mIvClose'");
    ...
    view = finder.findRequiredView(source, 2131624168, "field 'mTvPhoneNumber'");
    target.mTvPhoneNumber = finder.castView(view, 2131624168, "field 'mTvPhoneNumber'");
    view = finder.findRequiredView(source, 2131624169, "field 'mTvTime'");
    target.mTvTime = finder.castView(view, 2131624169, "field 'mTvTime'");
    view = finder.findRequiredView(source, 2131624170, "field 'mBtnCall'");
    target.mBtnCall = finder.castView(view, 2131624170, "field 'mBtnCall'");
  }
