...
/**
 * author：fangkai on 2017/10/31 21:01
 * em：617716355@qq.com
 */
public class SearchMyUserAdapter extends BaseRecyclerAdapter<MyUserBean, MyUserAdapter.ViewHolder> {


    private static HashMap<String, Integer> letterIndex = new HashMap<String, Integer>();

    public SearchMyUserAdapter(Context context, List datas) {
        super(context, datas);
    }
    ...
    public MyUserAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyUserAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyUserAdapter.ViewHolder holder, int position) {
