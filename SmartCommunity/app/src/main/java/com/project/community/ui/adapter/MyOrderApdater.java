    ...
    public void onBindFooterViewHolder(final BaseViewHolder holder, final int groupPosition) {
        ...
        switch (entity.orderStatus){
            case "0"://"0", #未发货
                ...
                if (entity.isCancel==0) holder.setText(R.id.item_foot_3,mContext.getString(R.string.my_order_address_cacel_order));
                else holder.setText(R.id.item_foot_3,mContext.getString(R.string.my_order_address_del_order));
                break;
            case "1"://:1：已发货
                holder.setVisible(R.id.item_foot_1,false)
                        .setVisible(R.id.item_foot_2,true)
