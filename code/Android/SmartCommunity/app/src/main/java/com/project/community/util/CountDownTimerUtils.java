...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        // mTextView.setBackgroundResource(R.drawable.bg_btn_dis); //设置按钮为灰色，这时是不能点击的
...
//        mTextView.setBackgroundResource(R.drawable.bg_btn_nor);  //还原背景色
//        mTextView.setBackgroundResource(R.drawable.button_round_login);
    }
}
