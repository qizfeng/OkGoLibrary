...
public class ServiesComApdater extends BaseQuickAdapter<CommentModel, BaseViewHolder> {
    public RecycleItemClickListener itemClickListener;//点击事件

    public ServiesComApdater(List<CommentModel> data, RecycleItemClickListener itemClick) {
