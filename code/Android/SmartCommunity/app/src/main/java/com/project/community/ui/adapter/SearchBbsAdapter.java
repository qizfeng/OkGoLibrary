...
/**
 * author：fangkai on 2017/10/30 10:11
 * em：617716355@qq.com
 */
public class SearchBbsAdapter extends BaseQuickAdapter<BbsBean.ArtListBean, BaseViewHolder> {
    public RecycleItemClickListener itemClickListener;//点击事件

    public SearchBbsAdapter(List<BbsBean.ArtListBean> data, RecycleItemClickListener itemClick) {
