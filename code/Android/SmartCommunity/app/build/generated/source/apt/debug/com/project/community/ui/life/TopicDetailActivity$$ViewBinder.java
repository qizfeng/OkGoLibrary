...
public class TopicDetailActivity$$ViewBinder<T extends com.project.community.ui.life.TopicDetailActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624282, "field 'mEtInput'");
    target.mEtInput = finder.castView(view, 2131624282, "field 'mEtInput'");
    view = finder.findRequiredView(source, 2131624283, "field 'mBtnSend'");
    target.mBtnSend = finder.castView(view, 2131624283, "field 'mBtnSend'");
    view = finder.findRequiredView(source, 2131624280, "field 'mCoordinatorLayout'");
    target.mCoordinatorLayout = finder.castView(view, 2131624280, "field 'mCoordinatorLayout'");
    view = finder.findRequiredView(source, 2131624281, "field 'mBottomLayout'");
    target.mBottomLayout = finder.castView(view, 2131624281, "field 'mBottomLayout'");
  }
