...
public class ModifyPwdActivity$$ViewBinder<T extends com.project.community.ui.user.ModifyPwdActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624243, "field 'mEtOldPwd'");
    target.mEtOldPwd = finder.castView(view, 2131624243, "field 'mEtOldPwd'");
    view = finder.findRequiredView(source, 2131624244, "field 'mEtNewPwd'");
    target.mEtNewPwd = finder.castView(view, 2131624244, "field 'mEtNewPwd'");
    ...
    view = finder.findRequiredView(source, 2131624192, "field 'mIvEyes' and method 'onShowPwd'");
