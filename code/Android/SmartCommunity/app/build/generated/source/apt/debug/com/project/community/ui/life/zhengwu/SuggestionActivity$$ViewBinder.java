...
public class SuggestionActivity$$ViewBinder<T extends com.project.community.ui.life.zhengwu.SuggestionActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624284, "field 'mEtTitle'");
    target.mEtTitle = finder.castView(view, 2131624284, "field 'mEtTitle'");
    view = finder.findRequiredView(source, 2131624286, "field 'mEtSuggest'");
    target.mEtSuggest = finder.castView(view, 2131624286, "field 'mEtSuggest'");
    view = finder.findRequiredView(source, 2131624287, "field 'mTvTxtCount'");
    target.mTvTxtCount = finder.castView(view, 2131624287, "field 'mTvTxtCount'");
