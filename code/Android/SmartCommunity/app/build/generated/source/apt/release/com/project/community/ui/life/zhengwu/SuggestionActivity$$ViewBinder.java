...
public class SuggestionActivity$$ViewBinder<T extends com.project.community.ui.life.zhengwu.SuggestionActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624264, "field 'mEtTitle'");
    target.mEtTitle = finder.castView(view, 2131624264, "field 'mEtTitle'");
    view = finder.findRequiredView(source, 2131624266, "field 'mEtSuggest'");
    target.mEtSuggest = finder.castView(view, 2131624266, "field 'mEtSuggest'");
    view = finder.findRequiredView(source, 2131624267, "field 'mTvTxtCount'");
    target.mTvTxtCount = finder.castView(view, 2131624267, "field 'mTvTxtCount'");
